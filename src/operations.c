...
operation *create_op_table(void) {
    ...
    return (operation[]){
        ...
        create_operation("INC", 1, 2, "$BC", NULL),
        create_operation("INC", 1, 1, "$B", NULL),
        create_operation("DEC", 1, 1, "$B", NULL),
        create_operation("LD", 2, 2, "$B", "$n8"),
        create_operation("RLCA", 1, 1, NULL, NULL),
        create_operation("LD", 3, 5, "$a16", "$SP"),
        create_operation("ADD", 1, 2, "$HL", "$BC"),
        create_operation("LD", 1, 2, "$A", "$BC"),
        create_operation("DEC", 1, 2, "$BC", NULL),
        create_operation("INC", 1, 1, "$C", NULL),
        create_operation("DEC", 1, 1, "$C", NULL),
        create_operation("LD", 2, 2, "$C", "$n8"),
        create_operation("RRCA", 1, 1, NULL, NULL),
        create_operation("STOP", 2, 1, "$n8", NULL),
        create_operation("LD", 3, 3, "$DE", "$n16"),
        create_operation("LD", 1, 2, "$DE", "$A"),
        create_operation("INC", 1, 2, "$DE", NULL),
        create_operation("INC", 1, 1, "$D", NULL),
        create_operation("DEC", 1, 1, "$D", NULL),
        create_operation("LD", 2, 2, "$D", "$n8"),
        create_operation("RLA", 1, 1, NULL, NULL),
        create_operation("JR", 2, 3, "$e8", NULL),
        create_operation("ADD", 1, 2, "$HL", "$DE"),
        create_operation("LD", 1, 2, "$A", "$DE"),
        create_operation("DEC", 1, 2, "$DE", NULL),
        create_operation("INC", 1, 1, "$E", NULL),
        create_operation("DEC", 1, 1, "$E", NULL),
        create_operation("LD", 2, 2, "$E", "$n8"),
        create_operation("RRA", 1, 1, NULL, NULL),
        create_operation("JR", 2, 3, "$NZ", "$e8"),
        create_operation("LD", 3, 3, "$HL", "$n16"),
        create_operation("LD", 1, 2, "$HL", "$A"),
        create_operation("INC", 1, 2, "$HL", NULL),
        create_operation("INC", 1, 1, "$H", NULL),
        create_operation("DEC", 1, 1, "$H", NULL),
        create_operation("LD", 2, 2, "$H", "$n8"),
        create_operation("DAA", 1, 1, NULL, NULL),
        create_operation("JR", 2, 3, "$Z", "$e8"),
        create_operation("ADD", 1, 2, "$HL", "$HL"),
        create_operation("LD", 1, 2, "$A", "$HL"),
        create_operation("DEC", 1, 2, "$HL", NULL),
        create_operation("INC", 1, 1, "$L", NULL),
        create_operation("DEC", 1, 1, "$L", NULL),
        create_operation("LD", 2, 2, "$L", "$n8"),
        create_operation("CPL", 1, 1, NULL, NULL),
        create_operation("JR", 2, 3, "$NC", "$e8"),
        create_operation("LD", 3, 3, "$SP", "$n16"),
        create_operation("LD", 1, 2, "$HL", "$A"),
        create_operation("INC", 1, 2, "$SP", NULL),
        create_operation("INC", 1, 3, "$HL", NULL),
        create_operation("DEC", 1, 3, "$HL", NULL),
        create_operation("LD", 2, 3, "$HL", "$n8"),
        create_operation("SCF", 1, 1, NULL, NULL),
        create_operation("JR", 2, 3, "$C", "$e8"),
        create_operation("ADD", 1, 2, "$HL", "$SP"),
        create_operation("LD", 1, 2, "$A", "$HL"),
        create_operation("DEC", 1, 2, "$SP", NULL),
        create_operation("INC", 1, 1, "$A", NULL),
        create_operation("DEC", 1, 1, "$A", NULL),
        create_operation("LD", 2, 2, "$A", "$n8"),
        create_operation("CCF", 1, 1, NULL, NULL),
        ...
        create_operation("HALT", 1, 1, NULL, NULL),
        create_operation("LD", 1, 2, "$HL", "$A"),
        ...
        create_operation("RET", 1, 5, "$NZ", NULL),
        create_operation("POP", 1, 3, "$BC", NULL),
        create_operation("JP", 3, 4, "$NZ", "$a16"),
        create_operation("JP", 3, 4, "$a16", NULL),
        create_operation("CALL", 3, 6, "$NZ", "$a16"),
        create_operation("PUSH", 1, 4, "$BC", NULL),
        create_operation("ADD", 2, 2, "$A", "$n8"),
        create_operation("RST", 1, 4, "$$00", NULL),
        ...
        create_operation("RST", 1, 4, "$$08", NULL),
        ...
        create_operation("RST", 1, 4, "$$10", NULL),
        ...
        create_operation("RLC", 2, 2, "$C", NULL),
        create_operation("RLC", 2, 2, "$D", NULL),
        create_operation("RLC", 2, 2, "$E", NULL),
        create_operation("RLC", 2, 2, "$H", NULL),
        create_operation("RLC", 2, 2, "$L", NULL),
        create_operation("RLC", 2, 4, "$HL", NULL),
        create_operation("RLC", 2, 2, "$A", NULL),
        create_operation("RRC", 2, 2, "$B", NULL),
        create_operation("RRC", 2, 2, "$C", NULL),
        create_operation("RRC", 2, 2, "$D", NULL),
        create_operation("RRC", 2, 2, "$E", NULL),
        create_operation("RRC", 2, 2, "$H", NULL),
        create_operation("RRC", 2, 2, "$L", NULL),
        create_operation("RRC", 2, 4, "$HL", NULL),
        create_operation("RRC", 2, 2, "$A", NULL),
        create_operation("RL", 2, 2, "$B", NULL),
        create_operation("RL", 2, 2, "$C", NULL),
        create_operation("RL", 2, 2, "$D", NULL),
        create_operation("RL", 2, 2, "$E", NULL),
        create_operation("RL", 2, 2, "$H", NULL),
        create_operation("RL", 2, 2, "$L", NULL),
        create_operation("RL", 2, 4, "$HL", NULL),
        create_operation("RL", 2, 2, "$A", NULL),
        create_operation("RR", 2, 2, "$B", NULL),
        create_operation("RR", 2, 2, "$C", NULL),
        create_operation("RR", 2, 2, "$D", NULL),
        create_operation("RR", 2, 2, "$E", NULL),
        create_operation("RR", 2, 2, "$H", NULL),
        create_operation("RR", 2, 2, "$L", NULL),
        create_operation("RR", 2, 4, "$HL", NULL),
        create_operation("RR", 2, 2, "$A", NULL),
        create_operation("SLA", 2, 2, "$B", NULL),
        create_operation("SLA", 2, 2, "$C", NULL),
        create_operation("SLA", 2, 2, "$D", NULL),
        create_operation("SLA", 2, 2, "$E", NULL),
        create_operation("SLA", 2, 2, "$H", NULL),
        create_operation("SLA", 2, 2, "$L", NULL),
        create_operation("SLA", 2, 4, "$HL", NULL),
        create_operation("SLA", 2, 2, "$A", NULL),
        create_operation("SRA", 2, 2, "$B", NULL),
        create_operation("SRA", 2, 2, "$C", NULL),
        create_operation("SRA", 2, 2, "$D", NULL),
        create_operation("SRA", 2, 2, "$E", NULL),
        create_operation("SRA", 2, 2, "$H", NULL),
        create_operation("SRA", 2, 2, "$L", NULL),
        create_operation("SRA", 2, 4, "$HL", NULL),
        create_operation("SRA", 2, 2, "$A", NULL),
        create_operation("SWAP", 2, 2, "$B", NULL),
        create_operation("SWAP", 2, 2, "$C", NULL),
        create_operation("SWAP", 2, 2, "$D", NULL),
        create_operation("SWAP", 2, 2, "$E", NULL),
        create_operation("SWAP", 2, 2, "$H", NULL),
        create_operation("SWAP", 2, 2, "$L", NULL),
        create_operation("SWAP", 2, 4, "$HL", NULL),
        create_operation("SWAP", 2, 2, "$A", NULL),
        create_operation("SRL", 2, 2, "$B", NULL),
        create_operation("SRL", 2, 2, "$C", NULL),
        create_operation("SRL", 2, 2, "$D", NULL),
        create_operation("SRL", 2, 2, "$E", NULL),
        create_operation("SRL", 2, 2, "$H", NULL),
        create_operation("SRL", 2, 2, "$L", NULL),
        create_operation("SRL", 2, 4, "$HL", NULL),
        create_operation("SRL", 2, 2, "$A", NULL),
